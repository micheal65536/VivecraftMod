...
@ClassDependentMixin("me.jellysquid.mods.sodium.client.model.vertex.type.ChunkVertexType")
public class IrisChunkProgramOverridesMixinSodium_0_4_8 {
    ...
    private void createAllPipelinesShadersSodium_0_4_8(
        ...
        ChunkVertexType chunkVertexType)
    {
        try {
            ((IrisChunkProgramOverridesExtension) this).vivecraft$createAllPipelinesShadersSodiumProcessing(
                sodiumTerrainPipeline, chunkVertexType,
